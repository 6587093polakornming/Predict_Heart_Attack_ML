...
class TestModelPredictions(unittest.TestCase):
    ...
    def test_prediction_cases(self):
        test_data = [
            {'thalachh': 157.00, 'exng': 0, 'oldpeak': 1.6, 'expected_pred': 1, 'expected_result': 'more chance of heart attack'},
            {'thalachh': 123.00, 'exng': 0, 'oldpeak': 0.6, 'expected_pred': 1, 'expected_result': 'more chance of heart attack'},
            {'thalachh': 154.00, 'exng': 0, 'oldpeak': 4.0, 'expected_pred': 0, 'expected_result': 'less chance of heart attack'},
        ]
